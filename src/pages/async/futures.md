...
Both examples are resource-efficient and non-blocking but they sequence operations differently---*create-then-compose* calls out to the three servers in parallel and will typically complete in about one third the time. This is something to watch out for when combining futures using for-comprehensions.
