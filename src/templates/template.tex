\documentclass[oneside,a4paper,$if(fontsize)$$fontsize$$else$11pt$endif$,$if(lang)$$lang$,$endif$$if(papersize)$$papersize$,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{$documentclass$}
...
Copyright 2014 Underscore Consulting LLP. All rights reserved.
\end{center}
\end{bottompar}
